...
module.exports = ({ production, extractCss, analyze, tests, hmr, port, host, apimock } = {}) => ({
  ...
  plugins: [
     ...
     ...when(
			...
			new CopyWebpackPlugin( {
				patterns: [
					...
					{
						from: "./node_modules/relativity-web-components/dist/images/symbol-defs.svg",
						to: "./images/symbol-defs.svg",
					},
					{
						from: "./node_modules/relativity-web-components/dist/images/icons",
						to: "./images/icons",
					},
				]
			})
		), // ignore dot (hidden) files
		...when(apimock || !production, new CopyWebpackPlugin({
				patterns: [
    ...
    new ModuleFederationPlugin({
      name: "app5",
      remotes: {
        app55: `app55@${getRemoteEntryUrl(3003)}`,
      },
    }),
